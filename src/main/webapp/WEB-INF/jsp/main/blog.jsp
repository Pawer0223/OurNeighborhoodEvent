...
<html>
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.jsp">Uptown</a>
    ...
    <section class="hero-wrap hero-wrap-2 ftco-degree-bg js-fullheight" style="background-image: url('resources/mainPage/images/bg_1.jpg');" data-stellar-background-ratio="0.5">
        ...
        <div class="row d-flex">
          ...
          <div class="col-md-3 d-flex ftco-animate">
              ...
              <div class="text">
                ...
                <a href="blog-single.jsp" class="block-20 img" style="background-image: url('resources/mainPage/images/image_5.jpg');">
	              </a>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              </div>
            </div>
          ...
          <div class="col-md-3 d-flex ftco-animate">
              ...
              <div class="text">
                ...
                <a href="blog-single.jsp" class="block-20 img" style="background-image: url('resources/mainPage/images/image_6.jpg');">
	              </a>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              </div>
            </div>
          ...
          <div class="col-md-3 d-flex ftco-animate">
              ...
              <div class="text">
                ...
                <a href="blog-single.jsp" class="block-20 img" style="background-image: url('resources/mainPage/images/image_7.jpg');">
	              </a>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              </div>
            </div>
          ...
          <div class="col-md-3 d-flex ftco-animate">
              ...
              <div class="text">
                ...
                <a href="blog-single.jsp" class="block-20 img" style="background-image: url('resources/mainPage/images/image_8.jpg');">
	              </a>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              </div>
            </div>
