...
<div class="container-fluid">
    <div class="row d-flex d-md-block flex-nowrap wrapper">
        ...
        <main class="col-md-9 float-left col px-5 pl-md-2 pt-2 main">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <button role="button" class="btn btn-outline-dark" data-toggle="collapse" data-target="#demo" aria-expanded="true">
                ...
                <div class="col-lg-6">
                    <button role="button" class="btn btn-outline-dark" data-toggle="collapse" data-target="#demo2" aria-expanded="true">
