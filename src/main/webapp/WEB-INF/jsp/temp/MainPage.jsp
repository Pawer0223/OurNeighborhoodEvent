    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav flex-row">
                <li class="nav-item mr-sm-2 text-truncate">
                    <a class="btn btn-secondary navbar-btn btn-block text-truncate" href="?page=invoice">Quick faktura</a>
                </li>
                ...
                <li class="nav-item text-truncate">
                    <a class="btn btn-danger navbar-btn btn-block text-truncate" href="?page=logout">Log ud</a>
                </li>
            </ul>
        </div>
    </div>
